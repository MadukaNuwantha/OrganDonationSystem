...
import image3 from './Image/Icons/employee.png';
import image4 from './Image/Icons/info.png';
import image5 from './Image/Icons/organ-donation (2).png';
import image6 from './Image/Icons/blood-donor-card.png';
        ...
        return(
            <div>
                <div className='container'>
                    <div className='bgcc align-middle'>
                        ...
                        <div className='row py-1'>
                            <div className='col-6'>
                                <a href='/doner/details'>
                                    <div className='d-flex justify-content-center'>
                                        <div className='rectangle'>
                                            <img src={image3} alt='' width="100" height="100" />
                                            <h3 className="py-3">Donor Details</h3>
                                        </div>
                                    </div>
                                </a>
                            </div>
                                ...
                                <a href='/patient/details'>
                                    <div className='d-flex justify-content-center'>
                                        <div className='rectangle'>
                                            ...
                                            <h3 className="py-3">Patients Details</h3>
                                        </div>
                                    </div>
                                </a>
                            </div>
                        ...
                        <div className='row py-1'>
                            ...
                            <div className='col-6'>
                                <a href='/availableorgans/details'>
                                    <div className='d-flex justify-content-center'>
                                        <div className='rectangle'>
                                            <img src={image6} alt='' width="100" height="100" />
                                            <h3 className="py-3">Orgon Details</h3>
                                        </div>
                                    </div>
                                </a>
                            </div>
